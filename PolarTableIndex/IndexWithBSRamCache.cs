...
{
    public class IndexWithBSRamCache<Tkey> : IIndex<Tkey> where Tkey : IComparable
    {
        ...
        public IndexWithBSRamCache(string indexName, PaEntry table, Func<object[], Tkey> keyProducer,
        ...
        public class HalfPair : IComparable, IComparer<Tkey>
        {
            ...
            private int hkey;
            private IndexWithBSRamCache<Tkey> index;
            public HalfPair(long rec_off, int hkey, IndexWithBSRamCache<Tkey> index)
            {
        ...
        public void Build()
        {
            ...
            {
                if (ii++ < diapasonLength) return true;
                ii = 0;
                bsRamCache[j++] = Convert.ToInt32(((object[])o)[0]);
                return true;
            });
